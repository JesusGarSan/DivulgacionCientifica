...
velocidad_emisor = column[0].number_input('Velocidad (m/s)', value= 10.0, min_value=-100.0, max_value=+100.0, step= 1.0, )
...
velocidad_receptor = column[1].number_input('Velocidad (m/s)', value= 0.0, min_value=-100.0, max_value=+100.0, step= 1.0, key='velocidad_receptor' )
